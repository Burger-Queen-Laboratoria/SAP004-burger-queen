...
export function ErrorDictionary(error) {
  ...
  this.storageErrorCode = {
    ...
    "storage/bucket-not-found":
      "Nenhum intervalo configurado para o Cloud Storage.",
  ...
  this.firestoreErrorCode = {
    ...
    "firestore/not-found":
      "não encontrado: algum documento solicitado não foi encontrado.",
    "firestore/internal": "internal: erros internos.",
    "firestore/unavailable":
      "indisponível: o serviço está indisponível no momento.",
    "firestore/data-loss":
  ...
  this.authErrorCode = {
    ...
    "auth/user-not-found":
      "Não há nenhum registro de usuário correspondente a este identificador.",
    "auth/user-disabled":
